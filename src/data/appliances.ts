...
export const appliances: Appliance[] = [
  ...
  // --- FortiGate/FortiWiFi 30G ---
  {
    ...
    powerSupply: "Single",
    endOfSale: null,
    notes: "Entry-level model for SOHO/teleworker. 5 GE RJ45 ports (1 WAN, 4 LAN). SP5 ASIC.",
  },
  {
    id: "fortiwifi-30g",
    vendor: "Fortinet",
  ...
  // --- FortiGate/FortiWiFi 40F ---
  {
    ...
    powerSupply: "Single",
    endOfSale: null,
    notes: "5 GE RJ45 ports (1 WAN, 1 FortiLink, 3 LAN). SOC4 ASIC. SSL VPN not supported on FortiOS 7.6+ (2GB RAM).",
  },
  {
    id: "fortiwifi-40f",
    vendor: "Fortinet",
  ...
  // --- MX67 / MX67W / MX67C ---
  {
    ...
    powerSupply: "Single",
    endOfSale: null,
    notes: "2 GE WAN + 10 GE LAN RJ45 ports. Warm spare HA supported. Requires Meraki license. Dual WAN via convertible LAN port.",
  },
  {
    id: "meraki-mx67w",
    vendor: "Cisco Meraki",

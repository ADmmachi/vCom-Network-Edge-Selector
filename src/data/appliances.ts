...
export const appliances: Appliance[] = [
  ...
  // --- FortiGate 400F ---
  {
    ...
    maxWanInterfaces: 4,
    maxLanPorts: 24,
    throughputMbps: 13500,
    firewallThroughputMbps: 79500,
    features: [],
    siteTypes: ["large_office", "datacenter_edge"],
    maxUsers: 750,
    haSupport: true,
